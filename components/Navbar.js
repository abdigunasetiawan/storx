    ...
    <div class="navbar fixed left-0 top-0 z-50 w-full bg-white shadow">
      <div class="container mx-auto flex h-14 w-full items-center justify-between px-4 md:gap-x-12 md:px-8 xl:h-16 xl:px-16">
        ...
        <a href="/" class="flex items-center gap-2">
          ...
          <span class="text-xl font-bold text-gray-800">Storx</span>
        </a>
        <!-- _Logo -->
        <!-- Search Form -->
        ...
        <div class="flex items-center gap-2">
          <a href="">
            <svg class="w-6 stroke-gray-700 md:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-search">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" />
              <path d="M21 21l-6 -6" />
            </svg>
          ...
          <a href="">
            <svg class="w-6 stroke-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <a href="">
            <svg class="w-6 stroke-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-user">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
